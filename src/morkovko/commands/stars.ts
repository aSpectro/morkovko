      ...
      service.checkUser(user.id).then((res) => {
        if (res.status === 200) {
          ...
          this.embed.addFields(
            {
              name: '!дебаф',
              value: `Наслать дебаф соседу за **${debuff}** ⭐. **!дебаф <игрок>**. Скорость роста его морковок замедлится на **50%** до **01:00 МСК**`,
              inline: true,
            },
            {
              name: '!вор',
            ...
            {
              name: '!удобрение',
              value: `Купить удобрение за **${dung}** ⭐. **!удобрение**. Вы получите бонус к скорости роста морковки **10%** и **+1см** к росту конкурсной морковки за каждое увеличение до **01:00 МСК**`,
              inline: true,
            },
          );
